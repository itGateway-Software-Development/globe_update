...
import { onMounted } from 'vue';
    ...
    const goDetail = (product_slug) => {
        router.push('/solar-product-detail/'+product_slug)
    }
            ...
            <div class="col-span-5 lg:col-span-4">
                ...
                <div class="lg:hidden">
                    <button
                        ...
                        data-drawer-target="solar-filter-drawer" 
                        data-drawer-show="solar-filter-drawer" 
                        data-drawer-placement="left" 
                        aria-controls="solar-filter-drawer"
                    >
                ...
                <div id="solar-filter-drawer" class="fixed top-0 left-0 h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-white w-80  z-[999]" tabindex="-1" aria-labelledby="drawer-left-label">
                    ...
                    <button type="button" data-drawer-hide="solar-filter-drawer" aria-controls="solar-filter-drawer" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 absolute top-2.5 end-2.5 inline-flex items-center justify-center " >
