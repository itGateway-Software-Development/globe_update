...
<template>
  <Container class="py-5 px-0 lg:px-28">
    <div class="flex gap-2 items-center my-3">
      <RouterLink :to="`/chuwi/${product?.category_slug}`" class="text-slate-500 underline underline-offset-4">{{ product?.category.charAt(0).toUpperCase() + product?.category.slice(1) }}</RouterLink>
