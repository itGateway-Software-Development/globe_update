...
<template>
    <section class="mt-0 lg:mt-10 py-10" v-if="products.length > 0">
        <Container>
            <SectionHeader title="Laptop Selection" link_name="View All" link="/category/laptops" description="Top available laptops" />
