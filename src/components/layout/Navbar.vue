...
<template>
  <header
    :class="`fixed top-0 left-0 w-full z-[999] bg-sky-50 duration-300 ${
  ...
  >
      ...
      <nav class="py-3 flex justify-between items-center">
        ...
        <div>
          <div class="relative">
            <input
              type="text"
              class="border border-slate-400 rounded-lg px-5 pe-14 py-[6px] w-full text-slate-700 placeholder:italic placeholder:text-sm focus:outline-none min-w-[600px]"
              v-model="searchInput"
              placeholder="Search..."
            />
    ...
    <nav :class="`w-full h-[45px] bg-sky-400 flex justify-center`">
      <ul class="flex items-center justify-center gap-8">
        <li>
          <RouterLink to="/">
            <span
              :class="`font-bold text-[17px]  hover:text-slate-700 ${
        ...
        >
          <span
            class="font-bold group-hover:text-slate-700 text-[17px] text-white"
            >Category</span
          >
          <svg
